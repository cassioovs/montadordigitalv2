...
export const paths = {
  ...
  // WHATS APP
  whatsApp: 'https://api.whatsapp.com/send/?phone=5519983527288&text=Ol%C3%A1%2C+vim+por+meio+do+site+www.montadordigital.com.br%2C+gostaria+de+fazer+um+or%C3%A7amento&type=phone_number&app_absent=0'
};
